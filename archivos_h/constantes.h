...
const int TIEMPO_ERROR = 2;

// TIEMPOS DE ESPERA MENU DE CONFIGURACION
const int TIEMPO_MODIFICAR_EDIFICIO = 2;
const int TIEMPO_LISTAR_TOTAL_EDIFICIOS = 5;
const int TIEMPO_COMENZAR_PARTIDA = 4;

// TIEMPOS DE ESPERA MENU DE PARTIDA
const int TIEMPO_CONSTRUIR_EDIFICIO = 2;
const int TIEMPO_LISTAR_MIS_EDIFICIOS = 5;
const int TIEMPO_DEMOLER_EDIFICIO = 2;
const int TIEMPO_ATACAR_EDIFICIO_COORDENADA = 2;
const int TIEMPO_REPARAR_EDIFICIO_COORDENADA = 2;
const int TIEMPO_COMPRAR_BOMBAS = 1;
const int TIEMPO_CONSULTAR_COORDENADAS = 4;
const int TIEMPO_MOSTRAR_INVENTARIO = 5;
const int TIEMPO_MOSTRAR_OBJETIVOS = 5;
const int TIEMPO_RECOLECTAR_RECURSOS_PRODUCIDOS = 2;
const int TIEMPO_MOVERSE_UNA_COORDENADA = 2;
